...
namespace MFiles.VAF.Extensions.Dashboards.Commands.CustomDomainCommandResolution
{
		...
		where TSecureConfiguration : class, new()
	{
		...
		{
			yield return new AsynchronousOperationCustomDomainCommandResolver<TSecureConfiguration>(VaultApplication);
			yield return new LogCustomDomainCommandResolver<TSecureConfiguration>(VaultApplication);
			yield return new AttributeCustomDomainCommandResolver(VaultApplication);
		}
