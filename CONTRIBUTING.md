...
First off, thank you for considering contributing to the M-Files VAF Extensions (Community)
...
[search the issue tracker](https://github.com/M-Files/VAF.Extensions.Community/issues?q=something)
to see if someone else in the community has already created a ticket.
If not, go ahead and [make one](https://github.com/M-Files/VAF.Extensions.Community/issues/new)!
...
* **Ensure the bug was not already reported** by [searching all
  issues](https://github.com/M-Files/VAF.Extensions.Community/issues?q=).

* If you're unable to find an open issue addressing the problem, [open a new
  one](https://github.com/M-Files/VAF.Extensions.Community/issues/new).  Be sure to
