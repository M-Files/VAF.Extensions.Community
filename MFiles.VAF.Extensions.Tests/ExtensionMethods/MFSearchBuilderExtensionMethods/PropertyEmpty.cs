...
namespace MFiles.VAF.Extensions.Tests.ExtensionMethods.MFSearchBuilderExtensionMethods
{
		...
		: PropertyValueSearchConditionTestBase<bool>
	{
		...
		public void AddsSearchCondition()
		{
			...
			mfSearchBuilder.PropertyEmpty(PropertyValueSearchConditionTestBase.TestBooleanPropertyId);
		...
		public void NegativePropertyIdThrows()
		{
			...
			// Add the search condition.
			mfSearchBuilder.PropertyEmpty(-1);
		}
		...
		public void SearchConditionAdded()
		{
			...
			Assert.AreEqual(MFilesAPI.MFConditionType.MFConditionTypeEqual, condition.ConditionType);
