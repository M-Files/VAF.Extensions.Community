...
namespace MFiles.VAF.Extensions.Tests.ExtensionMethods.MFSearchBuilderExtensionMethods
{
		...
		: PropertyValueSearchConditionTestBase<int?>
	{
		...
		/// <summary>
		/// Tests that calling
		/// <see cref="MFiles.VAF.Extensions.ExtensionMethods.MFSearchBuilderExtensionMethods.Year(Common.MFSearchBuilder, int, int, MFConditionType, MFParentChildBehavior)"/>
