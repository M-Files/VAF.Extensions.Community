...
namespace MFiles.VAF.Extensions.Tests.ExtensionMethods.MFSearchBuilderExtensionMethods
{
		...
		: PropertyValueSearchConditionTestBase<string>
	{
		...
		/// <summary>
		/// Tests that calling
		/// <see cref="Extensions.MFSearchBuilderExtensionMethods.Property(MFSearchBuilder, int, string, MFConditionType, MFParentChildBehavior, PropertyDefOrObjectTypes, DataFunctionCall)"/>
		...
		/// <summary>
		/// Tests that calling
		/// <see cref="VAF.Extensions.MFSearchBuilderExtensionMethods.Property(MFSearchBuilder, int, string, MFConditionType, MFParentChildBehavior, PropertyDefOrObjectTypes, DataFunctionCall)"/>
