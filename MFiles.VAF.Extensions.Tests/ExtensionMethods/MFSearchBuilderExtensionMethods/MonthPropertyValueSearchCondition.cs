...
namespace MFiles.VAF.Extensions.Tests.ExtensionMethods.MFSearchBuilderExtensionMethods
{
		...
		: PropertyValueSearchConditionTestBase<int?>
	{
		...
		/// <summary>
		/// Tests that calling
		/// <see cref="MFiles.VAF.Extensions.ExtensionMethods.MFSearchBuilderExtensionMethods.Month(Common.MFSearchBuilder, int, int, MFConditionType, MFParentChildBehavior)"/>
