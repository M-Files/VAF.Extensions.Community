...
namespace MFiles.VAF.Extensions.Tests.ExtensionMethods.MFSearchBuilderExtensionMethods
{
		...
		: PropertyValueSearchConditionTestBase<bool?>
	{
		...
		/// <summary>
		/// Tests that calling
		/// <see cref="MFiles.VAF.Extensions.ExtensionMethods.MFSearchBuilderExtensionMethods.Property(Common.MFSearchBuilder, int, bool?, MFConditionType, MFParentChildBehavior, DataFunctionCall)"/>
